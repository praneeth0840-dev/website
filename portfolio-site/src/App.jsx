...
const PROJECTS = [
  ...
  },
  {
    ...
    summary: "Connected all the marketing and sales tools so that when a lead comes in, it's automatically scored, assigned to the right rep, and moved through the pipeline — no manual steps.",
    detail: {
      ...
      impact: [
        ...
        "Consistent process applied to every lead — no exceptions, no missed follow-ups",
  ...
  {
    id: 4,
    title: "Sales forecasting & slippage model",
    ...
    detail: {
      problem: "Sales forecasts were unreliable. Deals that were marked as 'closing this month' were regularly slipping, and leadership only found out at the end of the quarter — too late to take corrective action.",
  ...
  },
  {
    ...
    detail: {
      ...
      impact: [
        ...
        "Consistent formatting and data sourcing every time — no human error",
  ...
  },
  {
    ...
    detail: {
      ...
      impact: [
        ...
        "Webhooks maintain live data sync — no manual exports or imports",
      ],
  ...
  },
  {
    ...
    detail: {
      problem: "Job hunting across multiple platforms (LinkedIn, Welcome to the Jungle, Ashby, Greenhouse, Lever) was taking 2–3 hours daily. Most listings were irrelevant, and manually scoring fit against a CV is subjective and slow.",
...
const EDUCATION = [
  {
    degree: "Double Degree: Master in Management (Grande École) & MSc Strategy and Consulting",
    ...
    highlights: [
      ...
      "A+ in Operations Management, Strategy & Business Models, and Financial Modelling & M&A",
    ...
    <div className={`pf${dark?" dark":""}`}>
      ...
      <nav className={`nav${dark?" dark":""}`}>
        <div className="nav-inner">
          <span className="nav-logo">Praneeth<span style={{ color:"#3B82F6" }}>.</span></span>
